const navToggleiIcon = document.querySelector(".nav__toggle-icon")
...
navToggleiIcon.addEventListener("click", function() {
    navToggleiIcon.classList.toggle("nav__toggle-icon--open")
...
function observerHandler(allSection) {
    allSection.map(section => {
        ...
        if (section.isIntersecting) {
            document.querySelector(`.menu__items[data-section=${sectionClassName}]`).classList.add("menu__items--active")
        } else {
            document.querySelector(`.menu__items[data-section=${sectionClassName}]`).classList.remove("menu__items--active")
        }
    })
}
...
menuItems.forEach(menuItem => {
    menuItem.addEventListener("click", function(e) {
        e.preventDefault
        document.querySelector(".menu__items--active").classList.remove("menu__items--active")
